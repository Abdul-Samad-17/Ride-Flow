...
select * from driver;
select * from vehicle;
update driver set verification_status = "Verified" where driver_id = 5;
update vehicle set verification_status = "Verified" where vehicle_id = 2;
update user set role = "Admin" where user_id = 6;